...
import 'package:uber_eats_consumer/model/TransBankSettingData.dart';
...
class PaymentScreenState extends State<PaymentScreen> {
  ...
  TransbankSettingData? transBankSettingData;
  ...
  getPaymentSettingData() async {
    ...
    transBankSettingData = await UserPreference.getTransbank();
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Visibility(
            visible: (transBankSettingData == null) ? false : transBankSettingData!.isEnabled,
            child: Column(
              children: [
                Divider(),
                CheckboxListTile(
                  onChanged: (bool? value) {
                    setState(() {
                      ...
                      selectedCardID = '';
                      transbank = true;
                      paymentOption = "Pay Online Via".tr() + "transbank";
                    });
                  },
                  value: transbank,
                  contentPadding: EdgeInsets.all(0),
                  secondary: FaIcon(FontAwesomeIcons.moneyBillWave),
                  title: Text(' Transbank'.tr()),
                ),
              ],
            ),
          ),
  ...
  stripeMakePayment({required String amount}) async {
    try {
