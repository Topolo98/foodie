...
import 'model/TransBankSettingData.dart';
...
class UserPreference {
  ...
  static String transbank= "Transbank";

  static setTransbank(TransbankSettingData transbankSettingData) async {
    final jsonData = jsonEncode(transbankSettingData);
    await _preferences.setString(transbank, jsonData);
  }

  static getTransbank() {
      final String? jsonData = _preferences.getString(transbank);
      if (jsonData != null) return TransbankSettingData.fromJson((jsonDecode(jsonData)));
    }
